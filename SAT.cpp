...
OBB::OBB(glm::vec3 &pos, std::vector<glm::vec3> &dir, glm::vec3 &len)
{
    i_Pos = pos;
    i_Dir = dir;
    i_Len = len;
    m_Dir.push_back(glm::vec3(0,0,0));
}
...
void OBB::update(glm::mat4 &Rotate, glm::mat4 &Trans, glm::mat4 &Scale)
{
...
float LenSegOnSeparateAxis( glm::vec3 *Sep, glm::vec3 *e1, glm::vec3 *e2, glm::vec3 *e3 )
{
